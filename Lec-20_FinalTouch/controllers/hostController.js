...
exports.postAddHome=(req, res, next) => {
  ...
  const hostId = req.user._id; // Assuming you have user authentication and the user ID is available in req.user._id

  //  const _id= Math.random().toString(); // Generate a random ID for the home
  console.log(homeName, location, price,homeImage);
